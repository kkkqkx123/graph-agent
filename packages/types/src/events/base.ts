...
export enum EventType {
  ...
  /** 动态线程已提交 */
  DYNAMIC_THREAD_SUBMITTED = 'DYNAMIC_THREAD_SUBMITTED',
  /** 动态线程已完成 */
  DYNAMIC_THREAD_COMPLETED = 'DYNAMIC_THREAD_COMPLETED',
  /** 动态线程失败 */
  DYNAMIC_THREAD_FAILED = 'DYNAMIC_THREAD_FAILED',
  /** 动态线程已取消 */
  DYNAMIC_THREAD_CANCELLED = 'DYNAMIC_THREAD_CANCELLED'
}
