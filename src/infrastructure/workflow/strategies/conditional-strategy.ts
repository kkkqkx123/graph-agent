...
export abstract class ExecutionStrategy {
  ...
  protected canExecuteNode(nodeId: string, context: ExecutionContext, workflowExecutor: WorkflowExecutor): Promise<boolean> {
    return workflowExecutor.canExecuteNode(nodeId, context);
  }
  
  protected executeNode(nodeId: string, context: ExecutionContext, workflowExecutor: WorkflowExecutor): Promise<any> {
    return workflowExecutor.executeNode(nodeId, context);
  }
  
  protected evaluateEdge(edgeId: string, context: ExecutionContext, workflowExecutor: WorkflowExecutor): Promise<boolean> {
