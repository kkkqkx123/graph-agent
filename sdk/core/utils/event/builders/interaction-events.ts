 ...
 */
export const buildUserInteractionRequestedEvent = (params: BuildParams<UserInteractionRequestedEvent> & { workflowId?: string; nodeId?: string }): UserInteractionRequestedEvent =>
 ...
 */
export const buildUserInteractionRespondedEvent = createBuilder<UserInteractionRespondedEvent>('USER_INTERACTION_RESPONDED');
 ...
 */
export const buildUserInteractionFailedEvent = (params: BuildParams<UserInteractionFailedEvent>): UserInteractionFailedEvent =>
 ...
 */
export const buildHumanRelayRequestedEvent = createBuilder<HumanRelayRequestedEvent>('HUMAN_RELAY_REQUESTED');

/**
 * Build human relay responded event
 */
export const buildHumanRelayRespondedEvent = createBuilder<HumanRelayRespondedEvent>('HUMAN_RELAY_RESPONDED');

/**
 * Build human relay processed event
 */
export const buildHumanRelayProcessedEvent = createBuilder<HumanRelayProcessedEvent>('HUMAN_RELAY_PROCESSED');

/**
 * Build human relay failed event
 */
export const buildHumanRelayFailedEvent = (params: BuildParams<HumanRelayFailedEvent>): HumanRelayFailedEvent =>
