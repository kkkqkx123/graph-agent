 ...
 */
export const buildTokenUsageWarningEvent = createBuilder<TokenUsageWarningEvent>('TOKEN_USAGE_WARNING');

/**
 * Build token limit exceeded event
 */
export const buildTokenLimitExceededEvent = createBuilder<TokenLimitExceededEvent>('TOKEN_LIMIT_EXCEEDED');
 ...
 */
export const buildConversationStateChangedEvent = createBuilder<ConversationStateChangedEvent>('CONVERSATION_STATE_CHANGED');
 ...
 */
export const buildContextCompressionRequestedEvent = createBuilder<ContextCompressionRequestedEvent>('CONTEXT_COMPRESSION_REQUESTED');

/**
 * Build context compression completed event
 */
export const buildContextCompressionCompletedEvent = createBuilder<ContextCompressionCompletedEvent>('CONTEXT_COMPRESSION_COMPLETED');
 ...
 */
export const buildLLMStreamAbortedEvent = createBuilder<LLMStreamAbortedEvent>('LLM_STREAM_ABORTED');
